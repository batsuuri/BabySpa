function dropdownEffectData(t) {
    var e = null,
        ...
        o = $(".dropdown-menu", t),
        a = i.parents("ul.nav");
    return a.height > 0 && (e = a.data("dropdown-in") || null, n = a.data("dropdown-out") || null), {
        target: t,
        dropdown: i,
        dropdownMenu: o,
...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    easeInOutElastic: function (t, e, n, i, o) {
        ...
        return e < 1 ? -.5 * (s * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * o - a) * (2 * Math.PI) / r)) + n : s * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * o - a) * (2 * Math.PI) / r) * .5 + i + n
    },
    ...
    if (!t.jQuery) {
        ...
        n.isWindow = function (t) {
            ...
            if (i) {
                if (r)
                    for (; a > o && n.apply(t[o], i) !== !1; o++);
                else
                    for (o in t)
                        if (n.apply(t[o], i) === !1) break
            } else if (r)
                for (; a > o && n.call(t[o], o, t[o]) !== !1; o++);
            else
                for (o in t)
                    if (n.call(t[o], o, t[o]) === !1) break; return t
            ...
            var t, e, i, o, a, r, s = arguments[0] || {},
                l = 1,
                c = arguments.length,
                u = !1;
            for ("boolean" == typeof s && (u = s, s = arguments[l] || {}, l++), "object" != typeof s && "function" !== n.type(s) && (s = {}), l === c && (s = this, l--); c > l; l++)
                if (null != (a = arguments[l]))
                    for (o in a) t = s[o], i = a[o], s !== i && (u && i && (n.isPlainObject(i) || (e = n.isArray(i))) ? (e ? (e = !1, r = t && n.isArray(t) ? t : []) : r = t && n.isPlainObject(t) ? t : {}, s[o] = n.extend(u, r, i)) : void 0 !== i && (s[o] = i));
            return s
    ...
    return function (t, e, n, i) {
        ...
        function l(t, n, i, o) {
            ...
            function p(e) {
                for (var n = 0, o = 1, a = b - 1; o != a && C[o] <= e; ++o) n += x;
                --o;
        ...
        function c(t, e) {
            var n = t;
            return m.isString(t) ? b.Easings[t] || (n = !1) : n = m.isArray(t) && 1 === t.length ? s.apply(null, t) : m.isArray(t) && 2 === t.length ? x.apply(null, t.concat([e])) : !(!m.isArray(t) || 4 !== t.length) && l.apply(null, t), n === !1 && (n = b.Easings[b.defaults.easing] ? b.defaults.easing : y), n
        }
        function u(t) {
            if (t) {
                        ...
                        for (var v = Math.min((e - p) / c.duration, 1), y = 0, x = l.length; x > y; y++) {
                            ...
                            if (r(S)) {
                                ...
                                for (var I in k)
                                    if ("element" !== I) {
                                        var A, P = k[I],
                                            D = m.isString(P.easing) ? b.Easings[P.easing] : P.easing;
                                        if (1 === v) A = P.endValue;
                                        else {
                                            var _ = P.endValue - P.startValue;
                                            if (A = P.startValue + _ * D(v, c, _), !f && A === P.currentValue) continue
                                        }
        ...
        function d(t, e) {
            ...
            for (var n = b.State.calls[t][0], o = b.State.calls[t][1], a = b.State.calls[t][2], s = b.State.calls[t][4], l = !1, c = 0, u = n.length; u > c; c++) {
                var d = n[c].element;
                if (e || a.loop || ("none" === a.display && w.setPropertyValue(d, "display", a.display), "hidden" === a.visibility && w.setPropertyValue(d, "visibility", a.visibility)), a.loop !== !0 && (h.queue(d)[1] === i || !/\.velocityQueueEntryFlag/i.test(h.queue(d)[1])) && r(d)) {
        ...
        var x = function () {
            ...
            return function t(e, i, o) {
                var a, r, s, l = {
                    ...
                    c = [0],
                    u = 0;
                for (e = parseFloat(e) || 500, i = parseFloat(i) || 20, o = o || null, l.tension = e, l.friction = i, a = null !== o, a ? (u = t(e, i), r = u / o * .016) : r = .016; s = n(s || l, r), c.push(1 + s.x), u += 16, Math.abs(s.x) > 1e-4 && Math.abs(s.v) > 1e-4;);
                return a ? function (t) {
        ...
        var w = b.CSS = {
            ...
            Hooks: {
                ...
                register: function () {
                    ...
                    if (p)
                        for (n in w.Hooks.templates) {
                            ...
                            "Color" === o[0] && (o.push(o.shift()), a.push(a.shift()), w.Hooks.templates[n] = [o.join(" "), a.join(" ")])
                        }
                    for (n in w.Hooks.templates) {
                        i = w.Hooks.templates[n], o = i[0].split(" ");
                        for (var t in o) {
                ...
                extractValue: function (t, e) {
                    ...
                    if (n) {
                        var i = n[0],
                            o = n[1];
                        return e = w.Hooks.cleanRootPropertyValue(i, e), e.toString().match(w.RegEx.valueSplit)[o]
                    }
                    return e
                },
            ...
            getPropertyValue: function (t, n, o, a) {
                function s(t, n) {
                    ...
                    if (8 >= p) l = h.css(t, n);
                        ...
                        var f;
                        f = r(t) === i ? e.getComputedStyle(t, null) : r(t).computedStyle ? r(t).computedStyle : r(t).computedStyle = e.getComputedStyle(t, null), "borderColor" === n && (n = "borderTopColor"), l = 9 === p && "filter" === n ? f.getPropertyValue(n) : f[n], ("" === l || null === l) && (l = t.style[n]), o()
                    }
                ...
                if (w.Hooks.registered[n]) {
                    ...
                    var d, f;
                    d = w.Normalizations.registered[n]("name", t), "transform" !== d && (f = s(t, w.Names.prefixCheck(d)[0]), w.Values.isCSSNullValue(f) && w.Hooks.templates[n] && (f = w.Hooks.templates[n][1])), l = w.Normalizations.registered[n]("extract", t, f)
                }
                if (!/^[\d-]/.test(l))
            ...
            setPropertyValue: function (t, n, i, o, a) {
                ...
                if ("scroll" === n) a.container ? a.container["scroll" + a.direction] = i : "Left" === a.direction ? e.scrollTo(i, a.alternateValue) : e.scrollTo(a.alternateValue, i);
                else if (w.Normalizations.registered[n] && "transform" === w.Normalizations.registered[n]("name", t)) w.Normalizations.registered[n]("inject", t, i), s = "transform", i = r(t).transformCache[n];
                else {
                    if (w.Hooks.registered[n]) {
                        var l = n,
                            c = w.Hooks.getRoot(n);
                    ...
                    } else r(t) && r(t).isSVG && w.Names.SVGAttribute(n) ? t.setAttribute(n, i) : t.style[s] = i;
        ...
        w.Hooks.register(), w.Normalizations.register(), b.hook = function (t, e, n) {
            ...
            return t = a(t), h.each(t, function (t, a) {
                if (r(a) === i && b.init(a), n === i) o === i && (o = b.CSS.getPropertyValue(a, e));
                else {
        ...
        var k = function () {
            ...
            function o() {
                function t(t) {
                    ...
                    if ("scroll" === A) {
                        var v, x, k, T = /^x$/i.test(s.axis) ? "Left" : "Top",
                            M = parseFloat(s.offset) || 0;
                        s.container ? m.isWrapped(s.container) || m.isNode(s.container) ? (s.container = s.container[0] || s.container, v = s.container["scroll" + T], k = v + h(a).position()[T.toLowerCase()] + M) : s.container = null : (v = b.State.scrollAnchor[b.State["scrollProperty" + T]], x = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === T ? "Top" : "Left")]], k = h(a).offset()[T.toLowerCase()] + M), l = {
                            scroll: {
                                rootPropertyValue: !1,
                                startValue: v,
                                currentValue: v,
                        ...
                        for (var D in P)
                            if ("element" !== D) {
                                ...
                                P[D].startValue = P[D].currentValue = P[D].endValue, P[D].endValue = _, m.isEmptyObject(y) || (P[D].easing = s.easing), b.debug && console.log("reverse tweensContainer (" + D + "): " + JSON.stringify(P[D]), a)
                            }
                        l = P
                    } else if ("start" === A) {
                        var P;
                        r(a).tweensContainer && r(a).isAnimating === !0 && (P = r(a).tweensContainer), h.each(g, function (t, e) {
                        ...
                        for (var E in g) {
                            ...
                            var z = w.Hooks.getRoot(E),
                                N = !1;
                            if (r(a).isSVG || "tween" === z || w.Names.prefixCheck(z)[1] !== !1 || w.Normalizations.registered[z] !== i) {
                                (s.display !== i && null !== s.display && "none" !== s.display || s.visibility !== i && "hidden" !== s.visibility) && /opacity|filter/.test(E) && !V && 0 !== R && (V = 0), s._cacheValues && P && P[E] ? (V === i && (V = P[E].endValue + P[E].unitType), N = r(a).rootPropertyValueCache[z]) : w.Hooks.registered[E] ? V === i ? (N = w.getPropertyValue(a, z), V = w.getPropertyValue(a, E, N)) : N = w.Hooks.templates[z][1] : V === i && (V = w.getPropertyValue(a, E));
                                var H, B, Y, j = !1;
                                if (H = p(E, V), V = H[0], Y = H[1], H = p(E, R), R = H[0].replace(/^([+-\/*])=/, function (t, e) {
                                    return j = e, ""
                                }), B = H[1], V = parseFloat(V) || 0, R = parseFloat(R) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(E) ? (R /= 100, B = "em") : /^scale/.test(E) ? (R /= 100, B = "") : /(Red|Green|Blue)$/i.test(E) && (R = R / 100 * 255, B = "")), /[\/*]/.test(j)) B = Y;
                                else if (Y !== B && 0 !== V)
                                    if (0 === R) B = Y;
                                    else {
                                        o = o || function () {
                ...
                var o, a = this,
                    ...
                    l = {};
                switch (r(a) === i && b.init(a), parseFloat(s.delay) && s.queue !== !1 && h.queue(a, s.queue, function (t) {
            ...
            if (m.isWrapped(this) ? (s = !1, p = 0, f = this, l = this) : (s = !0, p = 1, f = x ? arguments[0].elements || arguments[0].e : arguments[0]), f = a(f)) {
                ...
                if (!/^(stop|finish)$/i.test(g) && !h.isPlainObject(y)) {
                    var T = p + 1;
                    y = {};
                    for (var M = T; M < arguments.length; M++) m.isArray(arguments[M]) || !/^(fast|normal|slow)$/i.test(arguments[M]) && !/^\d/.test(arguments[M]) ? m.isString(arguments[M]) || m.isArray(arguments[M]) ? y.easing = arguments[M] : m.isFunction(arguments[M]) && (y.complete = arguments[M]) : y.duration = arguments[M]
                }
                var I = {
                    promise: null,
                    resolver: null,
                ...
                s && b.Promise && (I.promise = new b.Promise(function (t, e) {
                    ...
                    case "stop":
                        ...
                        return h.each(b.State.calls, function (t, e) {
                            e && h.each(e[1], function (n, o) {
                                var a = y === i ? "" : y;
                                return a !== !0 && e[2].queue !== a && (y !== i || e[2].queue !== !1) || void h.each(f, function (n, i) {
                        ...
                        if (!h.isPlainObject(g) || m.isEmptyObject(g)) {
                            if (m.isString(g) && b.Redirects[g]) {
                                var D = h.extend({}, y),
                                    _ = D.duration,
                                    E = D.delay || 0;
                                return D.backwards === !0 && (f = h.extend(!0, [], f).reverse()), h.each(f, function (t, e) {
                ...
                if (D.loop = parseInt(D.loop), R = 2 * D.loop - 1, D.loop)
                    for (var W = 0; R > W; W++) {
                        ...
                        W === R - 1 && (V.display = D.display, V.visibility = D.visibility, V.complete = D.complete), k(f, "reverse", V)
                    }
                return t()
            }
        };
        ...
        return function t(e, n, i) {
                ...
                function i(t) {
                    if (t) {
                        ...
                        if (i) {
                            ...
                            i = i[1];
                            for (var o = 0; o < e.length; o++) e[o] = parseInt(i.slice(2 * o, 2 * o + 2), 16)
                        } else if (i = t.match(/^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/)) {
                            for (var o = 0; o < e.length; o++) e[o] = parseInt(i[o + 1]);
                            n = parseFloat(i[4])
                        } else if (i = t.match(/^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/)) {
                            for (var o = 0; o < e.length; o++) e[o] = Math.round(2.55 * parseFloat(i[o + 1]));
                            n = parseFloat(i[4])
                        } else if (i = t.match(/(\w+)/)) {
                ...
                function o(t) {
                    if (t) {
                        ...
                        if (e) {
                            ...
                            return [y(parseInt(e[1]), 0, 360), y(parseFloat(e[2]), 0, 100), y(parseFloat(e[3]), 0, 100), y(isNaN(n) ? 1 : n, 0, 1)]
                        }
                    }
                }
                function a(t) {
                ...
                a.prototype = {
                    ...
                    clone: function () {
                        var t, e, n = new a,
                            i = this.values,
                            o = n.values;
                        for (var r in i) i.hasOwnProperty(r) && (t = i[r], e = {}.toString.call(t), "[object Array]" === e ? o[r] = t.slice(0) : "[object Number]" === e ? o[r] = t : console.error("unexpected color value:", t));
                        return n
                    }
                }, a.prototype.spaces = {
                    rgb: ["red", "green", "blue"],
                    ...
                    var c;
                    for (n = 0; n < t.length; n++) c = Math.max(0, Math.min(r[t][n], o[t][n])), o[t][n] = Math.round(c);
            ...
            4: [function (t, e, n) {
                function i(t) {
                    var e, n, i, o = t[0] / 255,
                        ...
                        l = Math.max(o, a, r),
                        c = l - s;
                    return l == s ? e = 0 : o == l ? e = (a - r) / c : a == l ? e = 2 + (r - o) / c : r == l && (e = 4 + (o - a) / c), e = Math.min(60 * e, 360), e < 0 && (e += 360), i = (s + l) / 2, n = l == s ? 0 : i <= .5 ? c / (l + s) : c / (2 - l - s), [e, 100 * n, 100 * i]
                }
                function o(t) {
                    var e, n, i, o = t[0],
                        a = t[1],
                        ...
                        l = Math.max(o, a, r),
                        c = l - s;
                    return n = 0 == l ? 0 : c / l * 1e3 / 10, l == s ? e = 0 : o == l ? e = (a - r) / c : a == l ? e = 2 + (r - o) / c : r == l && (e = 4 + (o - a) / c), e = Math.min(60 * e, 360), e < 0 && (e += 360), i = l / 255 * 1e3 / 10, [e, n, i]
                }
                function a(t) {
                    var e = t[0],
                        n = t[1],
                ...
                function h(t) {
                    ...
                    for (var c = 0; c < 3; c++) i = r + 1 / 3 * -(c - 1), i < 0 && i++ , i > 1 && i-- , a = 6 * i < 1 ? e + 6 * (n - e) * i : 2 * i < 1 ? n : 3 * i < 2 ? e + (n - e) * (2 / 3 - i) * 6 : e, o[c] = 255 * a;
                    return o
                }
                function p(t) {
                    var e, n, i = t[0],
                ...
                function W(t) {
                    var e, n, i, o, a = t[0],
                        r = t[1],
                        s = t[2];
                    return a <= 8 ? (n = 100 * a / 903.3, o = n / 100 * 7.787 + 16 / 116) : (n = 100 * Math.pow((a + 16) / 116, 3), o = Math.pow(n / 100, 1 / 3)), e = e / 95.047 <= .008856 ? e = 95.047 * (r / 500 + o - 16 / 116) / 7.787 : 95.047 * Math.pow(r / 500 + o, 3), i = i / 108.883 <= .008859 ? i = 108.883 * (o - s / 200 - 16 / 116) / 7.787 : 108.883 * Math.pow(o - s / 200, 3), [e, n, i]
                }
                function V(t) {
                    var e, n, i, o = t[0],
                        a = t[1],
                ...
                e.exports = function (t) {
                    ...
                    t.defaults.bar = {
                        ...
                        updateElement: function (t, n, i) {
                            ...
                            t._xScale = o.getScaleForId(r.xAxisID), t._yScale = o.getScaleForId(r.yAxisID), t._datasetIndex = o.index, t._index = n, t._model = {
                                datasetLabel: s.label,
                                label: a.data.labels[n],
                                borderSkipped: l.borderSkipped ? l.borderSkipped : c.borderSkipped,
                                backgroundColor: l.backgroundColor ? l.backgroundColor : e.getValueAtIndexOrDefault(s.backgroundColor, n, c.backgroundColor),
                                borderColor: l.borderColor ? l.borderColor : e.getValueAtIndexOrDefault(s.borderColor, n, c.borderColor),
                                borderWidth: l.borderWidth ? l.borderWidth : e.getValueAtIndexOrDefault(s.borderWidth, n, c.borderWidth)
                            }, o.updateElementGeometry(t, n, i), t.pivot()
                        },
                        ...
                        getRuler: function () {
                            var t = this,
                                ...
                                l = s / o,
                                c = l * i.barPercentage;
                            return c = Math.min(e.getValueOrDefault(i.barThickness, c), e.getValueOrDefault(i.maxBarThickness, 1 / 0)), {
                                stackCount: o,
                                tickSize: r,
                                categorySize: s,
                                categorySpacing: r - s,
                        ...
                        calculateBarValuePixels: function (t, e) {
                            ...
                            if (f || void 0 === f && void 0 !== m)
                                for (n = 0; n < t; ++n) i = c.getDatasetMeta(n), i.bar && i.stack === m && i.controller.getValueScaleId() === d.id && c.isDatasetVisible(n) && (o = Number(h[n].data[e]), (p < 0 && o < 0 || p >= 0 && o > 0) && (g += o));
                            return a = d.getPixelForValue(g), r = d.getPixelForValue(g + p), s = (r - a) / 2, {
                                size: s,
                                base: a,
                                head: r,
                                center: r + s / 2
                        ...
                        calculateBarIndexPixels: function (t, e, n) {
                            var i = this,
                                ...
                                l = n.barSize;
                            return s -= a ? n.tickSize / 2 : 0, s += n.fullBarSize * r, s += n.categorySpacing / 2, s += n.barSpacing / 2, {
                                size: l,
                                base: s,
                                head: s + l,
                                center: s + l / 2
                        ...
                        draw: function () {
                            var t, n = this,
                                ...
                                r = o.length,
                                s = 0;
                            for (e.canvas.clipArea(i.ctx, i.chartArea); s < r; ++s) null === (t = a.data[s]) || void 0 === t || isNaN(t) || o[s].draw();
                    ...
                    t.defaults.bubble = {
                        ...
                        updateElement: function (n, i, o) {
                            ...
                            e.extend(n, {
                                ...
                                _index: i,
                                _model: {
                                    x: o ? s.getPixelForDecimal(.5) : s.getPixelForValue("object" == typeof d ? d : NaN, i, p, a.chart.isCombo),
                                    y: o ? l.getBasePixel() : l.getPixelForValue(d, i, p),
                                    radius: o ? 0 : c.radius ? c.radius : a.getRadius(d),
                                    hitRadius: c.hitRadius ? c.hitRadius : e.getValueAtIndexOrDefault(u.hitRadius, i, h.hitRadius)
                                }
                            }), t.DatasetController.prototype.removeHoverStyle.call(a, n, h);
                            var f = n._model;
                            ...
                            labels: {
                                generateLabels: function (t) {
                                    ...
                                    return n.labels.length && n.datasets.length ? n.labels.map(function (i, o) {
                                        ...
                                        return {
                                            text: i,
                                            fillStyle: l.backgroundColor ? l.backgroundColor : c(r.backgroundColor, o, u.backgroundColor),
                                            strokeStyle: l.borderColor ? l.borderColor : c(r.borderColor, o, u.borderColor),
                                            lineWidth: l.borderWidth ? l.borderWidth : c(r.borderWidth, o, u.borderWidth),
                    ...
                    t.defaults.line = {
                        ...
                        update: function (t) {
                            var i, o, a, r = this,
                                ...
                                p = r.getDataset(),
                                f = e(p, u);
                            for (f && (a = l.custom || {}, void 0 !== p.tension && void 0 === p.lineTension && (p.lineTension = p.tension), l._scale = h, l._datasetIndex = r.index, l._children = c, l._model = {
                                spanGaps: p.spanGaps ? p.spanGaps : u.spanGaps,
                                tension: a.tension ? a.tension : n.getValueOrDefault(p.lineTension, d.tension),
                                backgroundColor: a.backgroundColor ? a.backgroundColor : p.backgroundColor || d.backgroundColor,
                                borderWidth: a.borderWidth ? a.borderWidth : p.borderWidth || d.borderWidth,
                                borderColor: a.borderColor ? a.borderColor : p.borderColor || d.borderColor,
                                borderCapStyle: a.borderCapStyle ? a.borderCapStyle : p.borderCapStyle || d.borderCapStyle,
                                borderDash: a.borderDash ? a.borderDash : p.borderDash || d.borderDash,
                                borderDashOffset: a.borderDashOffset ? a.borderDashOffset : p.borderDashOffset || d.borderDashOffset,
                                borderJoinStyle: a.borderJoinStyle ? a.borderJoinStyle : p.borderJoinStyle || d.borderJoinStyle,
                                fill: a.fill ? a.fill : void 0 !== p.fill ? p.fill : d.fill,
                                steppedLine: a.steppedLine ? a.steppedLine : n.getValueOrDefault(p.steppedLine, d.stepped),
                                cubicInterpolationMode: a.cubicInterpolationMode ? a.cubicInterpolationMode : n.getValueOrDefault(p.cubicInterpolationMode, d.cubicInterpolationMode)
                            }, l.pivot()), i = 0, o = c.length; i < o; ++i) r.updateElement(c[i], i, t);
                            for (f && 0 !== l._model.tension && r.updateBezierControlPoints(), i = 0, o = c.length; i < o; ++i) c[i].pivot()
                        },
                        ...
                        updateElement: function (t, e, i) {
                            var o, a, r = this,
                                ...
                                g = 1 === m.length || 1 === c.data.length || r.chart.isCombo;
                            void 0 !== c.radius && void 0 === c.pointRadius && (c.pointRadius = c.radius), void 0 !== c.hitRadius && void 0 === c.pointHitRadius && (c.pointHitRadius = c.hitRadius), o = p.getPixelForValue("object" == typeof d ? d : NaN, e, u, g), a = i ? h.getBasePixel() : r.calculatePointY(d, e, u), t._xScale = p, t._yScale = h, t._datasetIndex = u, t._index = e, t._model = {
                                x: o,
                                y: a,
                                skip: l.skip || isNaN(o) || isNaN(a),
                                radius: l.radius || n.getValueAtIndexOrDefault(c.pointRadius, e, f.radius),
                                pointStyle: l.pointStyle || n.getValueAtIndexOrDefault(c.pointStyle, e, f.pointStyle),
                                backgroundColor: r.getPointBackgroundColor(t, e),
                                borderColor: r.getPointBorderColor(t, e),
                                borderWidth: r.getPointBorderWidth(t, e),
                                tension: s.dataset._model ? s.dataset._model.tension : 0,
                                steppedLine: !!s.dataset._model && s.dataset._model.steppedLine,
                                hitRadius: l.hitRadius || n.getValueAtIndexOrDefault(c.pointHitRadius, e, f.hitRadius)
                            }
                        },
                        ...
                        updateBezierControlPoints: function () {
                            ...
                            if (l.dataset._model.spanGaps && (u = u.filter(function (t) {
                                ...
                                for (e = 0, i = u.length; e < i; ++e) o = u[e], a = o._model, r = n.splineCurve(n.previousItem(u, e)._model, a, n.nextItem(u, e)._model, l.dataset._model.tension), a.controlPointPreviousX = r.previous.x, a.controlPointPreviousY = r.previous.y, a.controlPointNextX = r.next.x, a.controlPointNextY = r.next.y;
                            if (s.chart.options.elements.line.capBezierPoints)
                                for (e = 0, i = u.length; e < i; ++e) a = u[e]._model, a.controlPointPreviousX = t(a.controlPointPreviousX, c.left, c.right), a.controlPointPreviousY = t(a.controlPointPreviousY, c.top, c.bottom), a.controlPointNextX = t(a.controlPointNextX, c.left, c.right), a.controlPointNextY = t(a.controlPointNextY, c.top, c.bottom)
                        },
                        draw: function () {
                            var n = this,
                                i = n.chart,
                                ...
                                s = a.length,
                                l = 0;
                            for (t.canvasHelpers.clipArea(i.ctx, r), e(n.getDataset(), i.options) && o.dataset.draw(), t.canvasHelpers.unclipArea(i.ctx); l < s; ++l) a[l].draw(r)
                        },
                        setHoverStyle: function (t) {
            ...
            19: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    t.defaults.polarArea = {
                        ...
                        updateElement: function (t, n, i) {
                            for (var o = this, a = o.chart, r = o.getDataset(), s = a.options, l = s.animation, c = a.scale, u = e.getValueAtIndexOrDefault, d = a.data.labels, h = o.calculateCircumference(r.data[n]), p = c.xCenter, f = c.yCenter, m = 0, g = o.getMeta(), v = 0; v < n; ++v) isNaN(r.data[v]) || g.data[v].hidden || ++m;
                            var y = s.startAngle,
                                b = t.hidden ? 0 : c.getDistanceFromCenterForValue(r.data[n]),
                                x = y + h * m,
                                w = x + (t.hidden ? 0 : h),
                                k = l.animateScale ? 0 : c.getDistanceFromCenterForValue(r.data[n]);
                            e.extend(t, {
                                _datasetIndex: o.index,
                                _index: n,
                                _scale: c,
                    ...
                    t.defaults.radar = {
                        ...
                        updateElement: function (t, n, i) {
                            ...
                            void 0 !== r.radius && void 0 === r.pointRadius && (r.pointRadius = r.radius), void 0 !== r.hitRadius && void 0 === r.pointHitRadius && (r.pointHitRadius = r.hitRadius), e.extend(t, {
                                ...
                                _model: {
                                    x: i ? s.xCenter : c.x,
                                    y: i ? s.yCenter : c.y,
                                    tension: a.tension ? a.tension : e.getValueOrDefault(r.lineTension, o.chart.options.elements.line.tension),
                                    radius: a.radius ? a.radius : e.getValueAtIndexOrDefault(r.pointRadius, n, l.radius),
                                    backgroundColor: a.backgroundColor ? a.backgroundColor : e.getValueAtIndexOrDefault(r.pointBackgroundColor, n, l.backgroundColor),
                                    borderColor: a.borderColor ? a.borderColor : e.getValueAtIndexOrDefault(r.pointBorderColor, n, l.borderColor),
                                    borderWidth: a.borderWidth ? a.borderWidth : e.getValueAtIndexOrDefault(r.pointBorderWidth, n, l.borderWidth),
                                    pointStyle: a.pointStyle ? a.pointStyle : e.getValueAtIndexOrDefault(r.pointStyle, n, l.pointStyle),
                                    hitRadius: a.hitRadius ? a.hitRadius : e.getValueAtIndexOrDefault(r.pointHitRadius, n, l.hitRadius)
                                }
                        ...
                        updateBezierControlPoints: function () {
                            ...
                            e.each(n.data, function (i, o) {
                                var a = i._model,
                                    r = e.splineCurve(e.previousItem(n.data, o, !0)._model, a, e.nextItem(n.data, o, !0)._model, a.tension);
            ...
            21: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    t.defaults.global.animation = {
                        ...
                        advance: function (t) {
                            for (var n, i, o = this.animations, a = 0; a < o.length;) n = o[a], i = n.chart, n.currentStep = (n.currentStep || 0) + t, n.currentStep = Math.min(n.currentStep, n.numSteps), e.callback(n.render, [i, n], i), e.callback(n.onAnimationProgress, [n], i), n.currentStep >= n.numSteps ? (e.callback(n.onAnimationComplete, [n], i), i.animating = !1, o.splice(a, 1)) : ++a
                        }
            ...
            22: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    e.drawPoint = function (e, n, i, o, a) {
                        var r, s, l, c, u, d;
                        if ("object" == typeof n && ("[object HTMLImageElement]" === (r = n.toString()) || "[object HTMLCanvasElement]" === r)) return void e.drawImage(n, o - n.width / 2, a - n.height / 2, n.width, n.height);
                        if (!(isNaN(i) || i <= 0)) {
                            switch (n) {
                                default: e.beginPath(),
                                ...
                                case "rectRounded":
                                    var h = i / Math.SQRT2,
                                        p = o - h,
                                        f = a - h,
                                        m = Math.SQRT2 * i; t.helpers.drawRoundedRectangle(e, p, f, m, m, i / 2),
                                            e.fill();
                                    break;
                                case "rectRot":
                                    d = 1 / Math.SQRT2 * i,
                    ...
                    t.types = {}, t.instances = {}, t.controllers = {}, o.extend(t.prototype, {
                        construct: function (n, i) {
                            ...
                            var s = r.acquireContext(n, i),
                                ...
                                c = l && l.height,
                                u = l && l.width;
                            if (a.id = o.uid(), a.ctx = s, a.canvas = l, a.config = i, a.width = u, a.height = c, a.aspectRatio = c ? u / c : null, a.options = i.options, a._bufferedRender = !1, a.chart = a, a.controller = a, t.instances[a.id] = a, Object.defineProperty(a, "data", {
                                get: function () {
                        ...
                        buildOrUpdateControllers: function () {
                            ...
                            if (o.each(e.data.datasets, function (o, a) {
                                ...
                                if (r.type || (r.type = o.type || e.config.type), n.push(r.type), r.controller) r.controller.updateIndex(a);
                                else {
                        ...
                        updateDataset: function (t) {
                            ...
                            a.notify(e, "beforeDatasetUpdate", [i]) !== !1 && (n.controller.update(), a.notify(e, "afterDatasetUpdate", [i]))
                        },
                        render: function (e, n) {
                            var i = this;
                        ...
                        draw: function (t) {
                            var e = this;
                            e.clear(), void 0 !== t && null !== t || (t = 1), e.transition(t), a.notify(e, "beforeDraw", [t]) !== !1 && (o.each(e.boxes, function (t) {
                                t.draw(e.chartArea)
                        ...
                        drawDataset: function (t, e) {
                            ...
                            a.notify(n, "beforeDatasetDraw", [o]) !== !1 && (i.controller.draw(e), a.notify(n, "afterDatasetDraw", [o]))
                        },
                        ...
                        updateHoverStyle: function (t, e, n) {
                            ...
                            for (o = 0, a = t.length; o < a; ++o)(i = t[o]) && this.getDatasetMeta(i._datasetIndex).controller[r](i)
                        },
                ...
                e.exports = function (t) {
                    ...
                    a.each = function (t, e, n, i) {
                        ...
                        if (a.isArray(t))
                            ...
                            var s = Object.keys(t);
                            for (r = s.length, o = 0; o < r; o++) e.call(n, t[s[o]], s[o])
                        }
                    }, a.clone = function (t) {
                        var e = {};
                        ...
                        var c, u, d, h;
                        for (e = 0; e < s - 1; ++e) i = r[e], o = r[e + 1], i.model.skip || o.model.skip || (a.almostEquals(i.deltaK, 0, this.EPSILON) ? i.mK = o.mK = 0 : (c = i.mK / i.deltaK, u = o.mK / i.deltaK, (h = Math.pow(c, 2) + Math.pow(u, 2)) <= 9 || (d = 3 / Math.sqrt(h), i.mK = c * d * i.deltaK, o.mK = u * d * i.deltaK)));
                        var p;
                        for (e = 0; e < s; ++e) i = r[e], i.model.skip || (n = e > 0 ? r[e - 1] : null, o = e < s - 1 ? r[e + 1] : null, n && !n.model.skip && (p = (i.model.x - n.model.x) / 3, i.model.controlPointPreviousX = i.model.x - p, i.model.controlPointPreviousY = i.model.y - p * i.mK), o && !o.model.skip && (p = (o.model.x - i.model.x) / 3, i.model.controlPointNextX = i.model.x + p, i.model.controlPointNextY = i.model.y + p * i.mK))
                    ...
                    a.requestAnimFrame = function () {
                        ...
                        return n = Math.round((n - s.left - c) / p * r.width / e.currentDevicePixelRatio), i = Math.round((i - s.top - u) / f * r.height / e.currentDevicePixelRatio), {
                            x: n,
                            y: i
                        }
                    ...
                    t.layoutService = {
                        ...
                        update: function (t, o, a) {
                            function r(t) {
                                ...
                                n ? (e = t.update(t.fullWidth ? w : I, M), A -= e.height) : (e = t.update(T, S), I -= e.width), P.push({
                                    horizontal: n,
                                    minSize: e,
                                    box: t
                                })
                            ...
                            if (t) {
                                var u = t.options.layout,
                                    ...
                                    f = 0,
                                    m = 0;
                                isNaN(d) ? (h = d.left || 0, p = d.right || 0, f = d.top || 0, m = d.bottom || 0) : (h = d, p = d, f = d, m = d);
                                ...
                                var L = h,
                                    ...
                                    R = f,
                                    W = m;
                                i.each(g.concat(v), s), i.each(g, function (t) {
                                    L += t.width
                                }), i.each(v, function (t) {
                                    F += t.width
                                ...
                                var B = h + V,
                                    Y = f + z;
                                i.each(g.concat(y), c), B += I, Y += A, i.each(v, c), i.each(b, c), t.chartArea = {
                                    left: L,
                                    top: R,
                                    right: L + I,
                                    bottom: R + A
                        ...
                        descriptors: function (n) {
                            ...
                            return this._plugins.concat(r.plugins || []).forEach(function (t) {
                                if (o.indexOf(t) === -1) {
                                    var n = t.id,
                                        i = l[n];
                                    i !== !1 && (i === !0 && (i = e.clone(s[n])), o.push(t), a.push({
                                        plugin: t,
                                        options: i || {}
                                    }))
                                }
                            ...
                            if (o.width = u ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : c && l.drawTicks ? p : 0, o.height = u ? c && l.drawTicks ? p : 0 : t.maxHeight, s.display && c && (u ? o.height += h : o.width += h), r.display && c) {
                                ...
                                if (u) {
                                    ...
                                    var w = t.ticks[0],
                                        ...
                                        S = e(t.ctx, C, d.font);
                                    0 !== t.labelRotation ? (t.paddingLeft = "bottom" === a.position ? y * k + 3 : y * g + 3, t.paddingRight = "bottom" === a.position ? y * g + 3 : y * S + 3) : (t.paddingLeft = k / 2 + 3, t.paddingRight = S / 2 + 3)
                            ...
                            if (a.display) {
                                ...
                                if (m) {
                                    if (r = !1, (C + u.autoSkipPadding) * o.ticks.length > o.width - (o.paddingLeft + o.paddingRight) && (r = 1 + Math.floor((C + u.autoSkipPadding) * o.ticks.length / (o.width - (o.paddingLeft + o.paddingRight)))), s && o.ticks.length > s)
                                        for (; !r || o.ticks.length / (r || 1) > s;) r || (r = 1), r += 1;
                                    f || (r = !1)
                                }
                                ...
                                if (i.each(o.ticks, function (t, n) {
                                    if (void 0 !== t && null !== t) {
                                        ...
                                        if ((!(r > 1 && n % r > 0 || n % r == 0 && n + r >= o.ticks.length) || s) && void 0 !== t && null !== t) {
                                            ...
                                            var v, b, x, k, C, P, D, _, E, O, L = "middle",
                                                F = "middle";
                                            if (m) {
                                                ...
                                                E = o.getPixelForTick(n, d.offsetGridLines) + u.labelOffset, v = x = C = D = R, b = I, k = A, P = e.top, _ = e.bottom
                                            } else {
                                                var W, V = "left" === a.position,
                                                    z = u.padding;
                                                u.mirror ? (L = V ? "left" : "right", W = z) : (L = V ? "right" : "left", W = y + z), E = V ? o.right - W : o.left + W;
                                                var N = o.getPixelForTick(n);
                                                N += i.aliasPixel(l), O = o.getPixelForTick(n, d.offsetGridLines), v = T, x = M, C = e.left, D = e.right, b = k = P = _ = N
                                            }
                                            S.push({
                                                tx1: v,
                                                ty1: b,
                                    ...
                                    if (d.display && (l.save(), l.lineWidth = t.glWidth, l.strokeStyle = t.glColor, l.setLineDash && (l.setLineDash(t.glBorderDash), l.lineDashOffset = t.glBorderDashOffset), l.beginPath(), d.drawTicks && (l.moveTo(t.tx1, t.ty1), l.lineTo(t.tx2, t.ty2)), d.drawOnChartArea && (l.moveTo(t.x1, t.y1), l.lineTo(t.x2, t.y2)), l.stroke(), l.restore()), u.display) {
                                        ...
                                        var e = t.label;
                                        if (i.isArray(e))
                                            for (var n = 0, o = 0; n < e.length; ++n) l.fillText("" + e[n], 0, o), o += 1.5 * v.size;
                                        else l.fillText(e, 0, 0);
                                        l.restore()
                                    }
                                }), h.display) {
                                    var P, D, _ = 0;
                                    if (m) P = o.left + (o.right - o.left) / 2, D = "bottom" === a.position ? o.bottom - x.size / 2 : o.top + x.size / 2;
                                    else {
                                        var E = "left" === a.position;
                                        P = E ? o.left + x.size / 2 : o.right - x.size / 2, D = o.top + (o.bottom - o.top) / 2, _ = E ? -.5 * Math.PI : .5 * Math.PI
                                    }
            ...
            34: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    function a(t, e) {
                        ...
                        }), p = 0, n.font = l.fontString(h, e._footerFontStyle, e._footerFontFamily), l.each(e.footer, f), o += 2 * e.xPadding, {
                                width: o,
                                height: i
                            }
                    }
                    ...
                    function s(t, e, n) {
                        var i = t.x,
                            ...
                            u = a + r,
                            d = s + r;
                        return "right" === l ? i -= e.width : "center" === l && (i -= e.width / 2), "top" === c ? o += u : o -= "bottom" === c ? e.height + u : e.height / 2, "center" === c ? "left" === l ? i += u : "right" === l && (i -= u) : "left" === l ? i -= d : "right" === l && (i += d), {
                            x: i,
                            y: o
                        }
                    }
                    ...
                    t.defaults.global.tooltips = {
                        ...
                        getCaretPosition: function (t, e, n) {
                            var i, o, a, r, s, l, c = n.caretSize,
                                ...
                                m = e.width,
                                g = e.height;
                            if ("center" === h) s = f + g / 2, "left" === d ? (i = p, o = i - c, a = i, r = s + c, l = s - c) : (i = p + m, o = i + c, a = i, r = s - c, l = s + c);
                            else if ("left" === d ? (o = p + u + c, i = o - c, a = o + c) : "right" === d ? (o = p + m - u - c, i = o - c, a = o + c) : (o = p + m / 2, i = o - c, a = o + c), "top" === h) r = f, s = r - c, l = r;
                            else {
                                r = f + g, s = r + c, l = r;
                                var v = a;
                                a = i, i = v
                        ...
                        drawTitle: function (t, n, i, o) {
                            ...
                            if (a.length) {
                                ...
                                var c, u;
                                for (c = 0, u = a.length; c < u; ++c) i.fillText(a[c], t.x, t.y), t.y += r + s, c + 1 === a.length && (t.y += n.titleMarginBottom - s)
                            }
                        },
                        ...
                        inRange: function (t, n) {
                            ...
                            if (i) {
                                for (var o = e.getAngleFromPoint(i, {
                                    x: t,
                                    y: n
                                }), a = o.angle, r = o.distance, s = i.startAngle, l = i.endAngle; l < s;) l += 2 * Math.PI;
                                for (; a > l;) a -= 2 * Math.PI;
                                for (; a < s;) a += 2 * Math.PI;
                                var c = a >= s && a <= l,
                    ...
                    i.elements.rectangle = {
                        ...
                        draw: function () {
                            ...
                            var e, n, i, o, a, r, s, l = this._chart.ctx,
                                c = this._view,
                                u = c.borderWidth;
                            if (c.horizontal ? (e = c.base, n = c.x, i = c.y - c.height / 2, o = c.y + c.height / 2, a = n > e ? 1 : -1, r = 1, s = c.borderSkipped || "left") : (e = c.x - c.width / 2, n = c.x + c.width / 2, i = c.y, o = c.base, a = 1, r = o > i ? 1 : -1, s = c.borderSkipped || "bottom"), u) {
            ...
            41: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    function o(t) {
                        var e = t.fill,
                            n = "dataset";
                        return e === !1 ? null : (isFinite(e) || (n = "boundary"), u[n](t))
                    }
                    function a(t) {
                        return t && !t.skip
                    }
                    function r(t, e, n, i, o) {
                        var a;
                        if (i && o) {
                            for (t.moveTo(e[0].x, e[0].y), a = 1; a < i; ++a) c.canvas.lineTo(t, e[a - 1], e[a]);
                            for (t.lineTo(n[o - 1].x, n[o - 1].y), a = o - 1; a > 0; --a) c.canvas.lineTo(t, n[a], n[a - 1], !0)
                        }
                    }
                    function s(t, e, n, i, o, s) {
                        var l, c, u, d, h, p, f, m = e.length,
                            g = i.spanGaps,
                            v = [],
                            y = [],
                            b = 0,
                            x = 0;
                        for (t.beginPath(), l = 0, c = m + !!s; l < c; ++l) u = l % m, d = e[u]._view, h = n(d, u, i), p = a(d), f = a(h), p && f ? (b = v.push(d), x = y.push(h)) : b && x && (g ? (p && v.push(d), f && y.push(h)) : (r(t, v, y, b, x), b = x = 0, v = [], y = []));
                    ...
                    return {
                        ...
                        afterDatasetsUpdate: function (a, r) {
                            var s, l, c, u, d = (a.data.datasets || []).length,
                                h = r.propagate,
                                p = [];
                            for (l = 0; l < d; ++l) s = a.getDatasetMeta(l), c = s.dataset, u = null, c && c._model && c instanceof t.elements.Line && (u = {
                                visible: a.isDatasetVisible(l),
                                fill: e(c, l, d),
                                chart: a,
                                el: c
                            }), s.$filler = u, p.push(u);
                            for (l = 0; l < d; ++l)(u = p[l]) && (u.fill = i(p, l, h), u.boundary = n(u), u.mapper = o(u))
                        },
                            ...
                            if (g ? (m.width = n.maxWidth, m.height = r ? 10 : 0) : (m.width = r ? 10 : 0, m.height = n.maxHeight), r)
                                if (s.font = p, g) {
                                    ...
                                    s.textAlign = "left", s.textBaseline = "top", i.each(n.legendItems, function (t, i) {
                                        ...
                                        v[v.length - 1] + r + a.padding >= n.width && (y += u + a.padding, v[v.length] = n.left), f[i] = {
                                            left: 0,
                                            top: 0,
                                            width: r,
                                            height: u
                                    ...
                                    i.each(n.legendItems, function (t, n) {
                                        ...
                                        C + S > m.height && (w += k + a.padding, x.push(k), k = 0, C = 0), k = Math.max(k, o), C += S, f[n] = {
                                            left: 0,
                                            top: 0,
                                            width: o,
                                            height: u
                                ...
                                var y = e(a, f),
                                    ...
                                    x = function (e, n, i) {
                                        if (!(isNaN(y) || y <= 0)) {
                                            ...
                                            } else a || d.strokeRect(e, n, y, f), d.fillRect(e, n, y, f);
                                            d.restore()
                                        }
                                    },
                                    w = function (t, e, n, i) {
                    ...
                    return t.defaults.global.title = {
                        ...
                        draw: function () {
                            var e = this,
                                ...
                                r = t.defaults.global;
                            if (a.display) {
                                var s, l, c, u = o(a.fontSize, r.defaultFontSize),
                    ...
                    var e = t.helpers,
                        ...
                        i = t.LinearScaleBase.extend({
                            determineDataLimits: function () {
                                ...
                                var l = i.stacked;
                                if (void 0 === l && e.each(r, function (e, n) {
                                    if (!l) {
                    ...
                    var e = t.helpers,
                        ...
                        i = t.Scale.extend({
                            determineDataLimits: function () {
                                ...
                                var u = i.stacked;
                                if (void 0 === u && e.each(s, function (e, n) {
                                    if (!u) {
                                        var i = a.getDatasetMeta(n);
                                        a.isDatasetVisible(n) && t(i) && void 0 !== i.stack && (u = !0)
                                    }
                                }), i.stacked || u) {
                                    var d = {};
                                    e.each(s, function (o, r) {
                                        var s = a.getDatasetMeta(r),
                                            l = [s.type, void 0 === i.stacked && void 0 === s.stack ? r : "", s.stack].join(".");
                                        a.isDatasetVisible(r) && t(s) && (void 0 === d[l] && (d[l] = []), e.each(o.data, function (t, e) {
                                            var o = d[l],
                                                a = +n.getRightValue(t);
                            ...
                            buildTicks: function () {
                                ...
                                n.isHorizontal() || r.reverse(), n.max = e.max(r), n.min = e.min(r), o.reverse ? (r.reverse(), n.start = n.max, n.end = n.min) : (n.start = n.min, n.end = n.max)
                            },
                            convertTicksToLabels: function () {
                            ...
                            getPixelForValue: function (t) {
                                var n, i, o, a = this,
                                    ...
                                    l = a.options,
                                    c = l.ticks;
                                return a.isHorizontal() ? (o = e.log10(a.end) - e.log10(r), 0 === s ? i = a.left : (n = a.width, i = a.left + n / o * (e.log10(s) - e.log10(r)))) : (n = a.height, 0 !== r || c.reverse ? 0 === a.end && c.reverse ? (o = e.log10(a.start) - e.log10(a.minNotZero), i = s === a.end ? a.top : s === a.minNotZero ? a.top + .02 * n : a.top + .02 * n + .98 * n / o * (e.log10(s) - e.log10(a.minNotZero))) : 0 === s ? i = c.reverse ? a.top : a.bottom : (o = e.log10(a.end) - e.log10(r), n = a.height, i = a.bottom - n / o * (e.log10(s) - e.log10(r))) : (o = e.log10(a.end) - e.log10(a.minNotZero), i = s === r ? a.bottom : s === a.minNotZero ? a.bottom - .02 * n : a.bottom - .02 * n - .98 * n / o * (e.log10(s) - e.log10(a.minNotZero)))), i
                            },
                            getValueForPixel: function (t) {
                                var n, i, o = this,
            ...
            48: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    function l(t, e, n, i) {
                        if (p.isArray(e))
                            for (var o = n.y, a = 1.5 * i, r = 0; r < e.length; ++r) t.fillText(e[r], n.x, o), o += a;
                    ...
                    function u(t) {
                        ...
                        var d = t.getDistanceFromCenterForValue(a.reverse ? t.min : t.max),
                            h = n(t);
                        i.textBaseline = "top";
                    ...
                    function d(t, n, i, o) {
                        var a = t.ctx;
                        if (a.strokeStyle = p.getValueAtIndexOrDefault(n.color, o - 1), a.lineWidth = p.getValueAtIndexOrDefault(n.lineWidth, o - 1), t.options.gridLines.circular) a.beginPath(), a.arc(t.xCenter, t.yCenter, i, 0, 2 * Math.PI), a.closePath(), a.stroke();
                        else {
                            var r = e(t);
                            if (0 === r) return;
                            a.beginPath();
                            ...
                            a.moveTo(s.x, s.y);
                            for (var l = 1; l < r; l++) s = t.getPointPosition(l, i), a.lineTo(s.x, s.y);
                ...
                i = "function" == typeof i ? i : window.moment, e.exports = function (t) {
                    ...
                    function n(t, e, n, i) {
                        for (var o, a = Object.keys(s), r = a.length, l = a.indexOf(t); l < r; l++) {
                            ...
                            if (void 0 === u || Math.ceil((n - e) / (u * c.size)) <= i) break
                        }
                        return o
                    }
                    function o(t, e, n, i) {
                        var o = s[n],
                            ...
                            c = e - t;
                        if (o.steps)
                            for (var u = o.steps.length, d = 0; d < u && r > i; d++) l = o.steps[d], r = Math.ceil(c / (a * l));
                        else
                    ...
                    function a(t, e, n) {
                        ...
                        if (t.maxTicks) {
                            ...
                            for (var r = i(n.min); r.add(a, t.unit).valueOf() < n.max;) o.push(r.valueOf());
                            var s = t.max || n.max;
                    ...
                    t.Ticks.generators.time = function (t, e) {
                        ...
                        return "week" === t.unit && r !== !1 ? (n = i(e.min).startOf("isoWeek").isoWeekday(r).valueOf(), o = i(e.max).startOf("isoWeek").isoWeekday(r), e.max - o > 0 && o.add(1, "week"), o = o.valueOf()) : (n = i(e.min).startOf(t.unit).valueOf(), o = i(e.max).startOf(t.unit), e.max - o > 0 && o.add(1, t.unit), o = o.valueOf()), a(t, e, {
                            min: n,
                            max: o
                        })
                    };
                    var c = t.Scale.extend({
                        ...
                        buildTicks: function () {
                            ...
                            s.ticks = t.Ticks.generators.time({
                                ...
                                isoWeekday: l.isoWeekday
                                    ...
                                    min: c,
                                    max: u
                                }), s.max = r.max(s.ticks), s.min = r.min(s.ticks)
                        },
                        ...
                        getPixelForValue: function (t, n, i) {
                            var o = this,
                                a = null;
                            if (void 0 !== n && void 0 !== i && (a = o._parsedData.datasets[i][n]), null === a && (t && t.isValid || (t = e(o, o.getRightValue(t))), t && t.isValid && t.isValid() && (a = t.valueOf())), null !== a) return o.getPixelForOffset(a)
                        },
                        getPixelForTick: function (t) {
...
WOW.prototype._initStorageVariables = function () {
    ...
    t.style.visibility = "visible", t.removeEventListener("animationstart", this._cleanupBoxVisibleListener[e]),
        t.removeEventListener("webkitAnimationStart", this._cleanupBoxVisibleListener[e]), delete this._cleanupBoxVisibleListener[e]
    ...
    function (t, e) {
        ...
        function a(t) {
            var n, i, o = {
                ...
                a = t && t.ownerDocument;
            return n = a.documentElement, void 0 !== t.getBoundingClientRect && (o = t.getBoundingClientRect()), i = e(a), {
                ...
                input: function (t) {
                    ...
                    if ("i" !== e.tagName.toLowerCase() || !e.classList.contains("waves-effect")) {
                        ...
                        var i = window.getComputedStyle(t, null),
                            o = i.color,
                            a = i.backgroundColor;
                        n.setAttribute("style", "color:" + o + ";background:" + a), t.setAttribute("style", "background-color:rgba(0,0,0,0);")
                    }
                },
                img: function (t) {
                    var e = t.parentNode;
        ...
        return u.init = function (t) {
            var e = document.body;
            t = t || {}, "duration" in t && (f.duration = t.duration), "delay" in t && (f.delay = t.delay), p && (e.addEventListener("touchstart", c, !1), e.addEventListener("touchcancel", g.registerEvent, !1), e.addEventListener("touchend", g.registerEvent, !1)), e.addEventListener("mousedown", c, !1)
        }, u.attach = function (t, e) {
            t = o(t), "[object Array]" === h.call(e) && (e = e.join(" ")), e = e ? " " + e : "";
            for (var n, i, a = 0, r = t.length; a < r; a++) n = t[a], i = n.tagName.toLowerCase(), ["input", "img"].indexOf(i) !== -1 && (m[i](n), n = n.parentElement), n.className.indexOf("waves-effect") === -1 && (n.className += " waves-effect" + e)
        }, u.ripple = function (t, e) {
            t = o(t);
            var n = t.length;
            if (e = e || {}, e.wait = e.wait || 0, e.position = e.position || null, n)
                for (var i, r, s, l = {}, c = 0, u = {
                    type: "mousedown",
                    button: 1
                }; c < n; c++)
                    if (i = t[c], r = e.position || {
                        x: i.clientWidth / 2,
                        y: i.clientHeight / 2
                    }, s = a(i), l.x = s.left + r.x, l.y = s.top + r.y, u.pageX = l.x, u.pageY = l.y, f.show(u, i), e.wait >= 0 && null !== e.wait) {
                        var d = {
                            type: "mouseup",
                            button: 1
                        };
            ...
            for (var e = {
                type: "mouseup",
                button: 1
            }, n = 0, i = t.length; n < i; n++) f.hide(e, t[n])
            ...
            t(document).on("click.card", ".card", function (e) {
                ...
                if (n.find(".card-reveal").length) {
                    var i = t(e.target),
                        ...
                        a = (i.is(".card-reveal .card-title i"), i.is(".card .activator")),
                        r = i.is(".card .activator i");
                    o || isTitleIcon ? n.find(".card-reveal").velocity({
                        translateY: 0
                    }, {
                            duration: 225,
                            queue: !1,
                ...
                console.log("click"), t("#" + t(this).attr("data-card")).toggleClass("flipped")
            })
        })
        ...
        t(["jquery"], function (t) {
            return function () {
                ...
                function f(e) {
                    ...
                    function c(e) {
                        if (!t(":focus", k).length || e) return clearTimeout(I.intervalId), k[f.hideMethod]({
                    ...
                    function d() {
                        clearTimeout(w), I.hideEta = 0, k.stop(!0, !0)[f.showMethod]({
                    ...
                    if (void 0 !== e.optionsOverride && (f = t.extend(f, e.optionsOverride), y = e.optionsOverride.iconClass || y), ! function (t, e) {
                        ...
                        return function () {
                            ...
                            function () {
                                k.hide(), k[f.showMethod]({
                                    duration: f.showDuration,
                                    easing: f.showEasing,
                                    complete: f.onShown
                                }), f.timeOut > 0 && (w = setTimeout(c, f.timeOut), I.maxHideTime = parseFloat(f.timeOut), I.hideEta = (new Date).getTime() + I.maxHideTime, f.progressBar && (I.intervalId = setInterval(h, 10)))
                            }(),
                            function () {
    ...
    function (t) {
        t.fn.scrollTo = function (e) {
            ...
            this.each(function () {
                ...
                function o(e) {
                    "focus" === e && (l = !0), i(), c.addClass("active"), r.addClass("active"), s.constrain_width === !0 ? c.css("width", r.outerWidth()) : c.css("white-space", "nowrap");
    ...
    function (t, e, n, i) {
        ...
        function I(t, e) {
            var n = e.center,
                ...
                o = t.prevDelta || {},
                a = t.prevInput || {};
            e.eventType !== Tt && a.eventType !== It || (o = t.prevDelta = {
                x: a.deltaX || 0,
                y: a.deltaY || 0
            }, i = t.offsetDelta = {
                x: n.x,
        ...
        function A(t, e) {
            var n, o, a, r, s = t.lastInterval || e,
            ...
            } else n = s.velocity, o = s.velocityX, a = s.velocityY, r = s.direction;
        ...
        function B(t, e) {
            var n = y(t.touches),
                i = this.targetIds;
            if (e & (Tt | Mt) && 1 === n.length) return i[n[0].identifier] = !0, [n, n];
            var o, a, r = y(t.changedTouches),
                s = [],
                l = this.target;
            ...
            for (o = 0; o < r.length;) i[r[o].identifier] && s.push(r[o]), e & (It | At) && delete i[r[o].identifier], o++;
        ...
        var vt = s(function (t, e, n) {
            for (var o = Object.keys(e), a = 0; a < o.length;)(!n || n && t[o[a]] === i) && (t[o[a]] = e[o[a]]), a++;
            return t
        }, "extend", "Use `assign`."),
            yt = s(function (t, e) {
                return vt(t, e, !0)
        ...
        l(W, C, {
            handler: function (t) {
                var e = zt[t.type];
                e & Tt && 0 === t.button && (this.pressed = !0), e & Mt && 1 !== t.which && (e = It), this.pressed && (e & It && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: "mouse",
                    srcEvent: t
        ...
        t.MSPointerEvent && !t.PointerEvent && (jt = "MSPointerDown", $t = "MSPointerMove MSPointerUp MSPointerCancel"), l(V, C, {
            handler: function (t) {
                var e = this.store,
                    n = !1,
                ...
                o & Tt && (0 === t.button || r) ? s < 0 && (e.push(t), s = e.length - 1) : o & (It | At) && (n = !0), s < 0 || (e[s] = t, this.callback(this.manager, o, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: a,
                    srcEvent: t
        ...
        Q.prototype = {
            ...
            directionTest: function (t) {
                var e = this.options,
                    ...
                    a = t.deltaX,
                    r = t.deltaY;
                return o & e.direction || (e.direction & Lt ? (o = 0 === a ? Pt : a < 0 ? Dt : _t, n = a != this.pX, i = Math.abs(t.deltaX)) : (o = 0 === r ? Pt : r < 0 ? Et : Ot, n = r != this.pY, i = Math.abs(t.deltaY))), t.direction = o, n && i > e.threshold && o & e.direction
            },
            attrTest: function (t) {
            ...
            process: function (t) {
                ...
                if (this._input = t, !i || !n || t.eventType & (It | At) && !a) this.reset();
        ...
        st.prototype = {
            ...
            recognize: function (t) {
                ...
                if (!e.stopped) {
                    ...
                    for (var a = 0; a < i.length;) n = i[a], 2 === e.stopped || o && n != o && !n.canRecognizeWith(o) ? n.reset() : n.recognize(t), !o && n.state & (le | ce | ue) && (o = e.curRecognizer = n), a++
                }
            },
            get: function (t) {
...
! function (t) {
    var e = 240,
        ...
        i = function () {
            function i(o, a) {
                ...
                t("body").append(d), "left" == a.edge ? (this.menu_id.css("transform", "translateX(-100%)"), d.css({
                    left: 0
                })) : (this.menu_id.addClass("right-aligned").css("transform", "translateX(100%)"), d.css({
                    right: 0
                })), this.menu_id.hasClass("fixed") && (window.innerWidth > n && this.menu_id.css("transform", "translateX(0)"), t(window).resize(function () {
                    ...
                    if (e.preventDefault(), s === !0) s = !1, r.removeMenu();
                        ...
                        n.append(i), "left" === r.options.edge ? r.menu_id.velocity({
                    ...
                    if ("touch" == e.gesture.pointerType) {
                        ...
                        if ("left" === a.edge && (n > a.menuWidth ? n = a.menuWidth : n < 0 && (n = 0)), "left" === a.edge) n < a.menuWidth / 2 ? s = !1 : n >= a.menuWidth / 2 && (s = !0), r.menu_id.css("transform", "translateX(" + (n - a.menuWidth) + "px)");
                        else {
                        ...
                        var u;
                        "left" === a.edge ? (u = n / a.menuWidth, t("#sidenav-overlay").velocity({
                            opacity: u
                        }, {
                                duration: 10,
                                queue: !1,
                                easing: "easeOutQuad"
                            })) : (u = Math.abs((n - window.innerWidth) / a.menuWidth), t("#sidenav-overlay").velocity({
                                opacity: u
                            }, {
                                    duration: 10,
                                    queue: !1,
                    ...
                    if ("touch" == e.gesture.pointerType) {
                        var n = e.gesture.velocityX,
                            ...
                            o = i - a.menuWidth,
                            l = i - a.menuWidth / 2;
                        o > 0 && (o = 0), l < 0 && (l = 0), "left" === a.edge ? s && n <= .3 || n < -.5 ? (0 != o && r.menu_id.velocity({
                            translateX: [0, o]
                        }, {
                                duration: 300,
                                queue: !1,
    ...
    function (t, e) {
        ...
        var e = function (t, e) {
            ...
            var a = 1;
            window.devicePixelRatio > 1 && (a = window.devicePixelRatio, i.style.width = i.style.height = [e.size, "px"].join(""), i.width = i.height = e.size * a, o.scale(a, a)), o.translate(e.size / 2, e.size / 2), o.rotate((-.5 + e.rotate / 180) * Math.PI);
            ...
            this.getCanvas = function () {
                ...
                e.scaleColor || e.trackColor ? o.getImageData && o.putImageData ? n ? o.putImageData(n, 0, 0) : (u(), n = o.getImageData(0, 0, e.size * a, e.size * a)) : (this.clear(), u()) : this.clear(), o.lineCap = e.lineCap;
                var i;
                ...
                var o = function () {
                    ...
                    this.draw(r), e.onStep(t, n, r), a >= e.animate.duration ? e.onStop(t, n) : c(o)
                }.bind(this);
                c(o)
            }.bind(this)
        },
    ...
    function (t) {
        ...
        t(e).each(o), t(document).on("change", e, function (e) {
            ...
            (!r.length && o(), r.find(".value").html(a.val()), n = !0, a.addClass("active"), r.hasClass("active") || r.velocity({
                height: "30px",
                width: "30px",
                top: "-20px",
                marginLeft: "-15px"
                    ...
                    duration: 300,
                    easing: "easeOutExpo"
                }), "input" !== e.type) && (i = void 0 === e.pageX || null === e.pageX ? e.originalEvent.touches[0].pageX - t(this).offset().left : e.pageX - t(this).offset().left, i < 0 ? i = 0 : i > s && (i = s), r.addClass("active").css("left", i));
        ...
        t.fn.material_select = function (e) {
            ...
            t(this).each(function () {
                ...
                if (!i.hasClass("browser-default")) {
                    ...
                    var c = t('<ul id="select-options-' + s + '" class="dropdown-content select-dropdown ' + (a ? "multiple-select-dropdown" : "") + '"></ul>'),
                    ...
                    m && function () {
                        var e = i.attr("searchable"),
                            n = t('<span class="search-wrap"><input type="text" class="search" placeholder="' + e + '"></span>');
                        c.append(n), n.find(".search").keyup(f)
                    }();
                    var g = function (e, n, i) {
                        ...
                        if (r) {
                            var l = "";
                            return s && (l = ' class="' + s + '"'), "multiple" === i ? c.append(t('<li class="' + o + '"><img alt="" src="' + r + '"' + l + '><span class="filtrable"><input type="checkbox"' + o + "/><label></label>" + n.html() + "</span></li>")) : c.append(t('<li class="' + o + a + '"><img alt="" src="' + r + '"' + l + '><span class="filtrable">' + n.html() + "</span></li>")), !0
                        }
                        "multiple" === i ? c.append(t('<li class="' + o + '"><span class="filtrable"><input type="checkbox"' + o + "/><label></label>" + n.html() + "</span></li>")) : c.append(t('<li class="' + o + a + '"><span class="filtrable">' + n.html() + "</span></li>"))
                    };
                    u.length && u.each(function () {
                        if (t(this).is("option")) a ? g(0, t(this), "multiple") : g(0, t(this));
                        else if (t(this).is("optgroup")) {
                            var e = t(this).children("option");
                            c.append(t('<li class="optgroup"><span>' + t(this).attr("label") + "</span></li>")), e.each(function () {
                        ...
                        t(this).click(function (r) {
                            if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
                                ...
                                a ? (t('input[type="checkbox"]', this).prop("checked", function (t, e) {
                                    return !e
                                }), s = n(d, t(this).index(), i), b.trigger("focus")) : (c.find("li").removeClass("active"), t(this).toggleClass("active"), b.val(t(this).text())), x(c, t(this)), i.find("option").eq(o).prop("selected", s), i.trigger("change"), void 0 !== e && e()
                            }
                            r.stopPropagation()
                        })
                    }), i.wrap(l);
                    var v = t('<span class="caret">&#9660;</span>');
                    i.is(":disabled") && v.addClass("disabled");
                    var y = p.replace(/"/g, "&quot;"),
                        b = t('<input type="text" class="select-dropdown" readonly="true" ' + (i.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + s + '" value="' + y + '"/>');
                    i.before(b), b.before(v), b.after(c), i.is(":disabled") || b.dropdown({
                        ...
                        focus: function () {
                            if (t("ul.select-dropdown").not(c[0]).is(":visible") && t("input.select-dropdown").trigger("close"), !c.is(":visible")) {
                        ...
                        a || m || t(this).trigger("close"), c.find("li.selected").removeClass("selected")
                    }), !a && m && c.find("li").on("click", function () {
                        b.trigger("close")
                    }), c.hover(function () {
                        h = !0
                    }, function () {
                    ...
                    var x = function (e, n) {
                        ...
                        k = function (e) {
                            ...
                            if (40 == e.which && !c.is(":visible")) return void b.trigger("open");
                            if (13 != e.which || c.is(":visible")) {
                                ...
                                if (13 == e.which) {
                                    ...
                                    s && (t(s).trigger("click"), a || b.trigger("close"))
                                }
                                40 == e.which && (r = c.find("li.selected").length ? c.find("li.selected").next("li:not(.disabled)")[0] : c.find("li:not(.disabled)")[0], x(c, r)), 27 == e.which && b.trigger("close"), 38 == e.which && (r = c.find("li.selected").prev("li:not(.disabled)")[0]) && x(c, r), setTimeout(function () {
                                    w = []
                                }, 1e3)
                            }
                        };
            ...
            function g() {
                I.$holder.on({
                    ...
                    var e = t(this),
                        ...
                        o = s();
                    o = o && (o.type || o.href), (i || o && !t.contains(I.$root[0], o)) && I.$holder[0].focus(), !i && n.nav ? I.set("highlight", I.component.item.highlight, {
                        nav: n.nav
                    }) : !i && "pick" in n ? (I.set("select", n.pick), C.closeOnSelect && I.close(!0)) : n.clear ? (I.clear(), C.closeOnClear && I.close(!0)) : n.close && I.close(!0)
                })
            }
            function v() {
                var e;
                C.hiddenName === !0 ? (e = a.name, a.name = "") : (e = ["string" == typeof C.hiddenPrefix ? C.hiddenPrefix : "", "string" == typeof C.hiddenSuffix ? C.hiddenSuffix : "_submit"], e = e[0] + a.name + e[1]), I._hidden = t('<input type=hidden name="' + e + '"' + (T.data("value") || a.value ? ' value="' + I.get("select", C.formatSubmit) + '"' : "") + ">")[0], T.on("change." + k.id, function () {
                ...
                I = M.prototype = {
                    ...
                    start: function () {
                        return k && k.start ? I : (k.methods = {}, k.start = !0, k.open = !1, k.type = a.type, a.autofocus = a == s(), a.readOnly = !C.editable, a.id = a.id || k.id, "text" != a.type && (a.type = "text"), I.component = new l(I, C), I.$root = t('<div class="' + S.picker + '" id="' + a.id + '_root" />'), m(), I.$holder = t(p()).appendTo(I.$root), g(), C.formatSubmit && v(), f(), C.containerHidden ? t(C.containerHidden).append(I._hidden) : T.after(I._hidden), C.container ? t(C.container).append(I.$root) : T.after(I.$root), I.on({
                            ...
                            close: C.onClose,
                            set: C.onSet
                        }), w = n(I.$holder[0]), a.autofocus && I.open(), I.trigger("start").trigger("render"))
                    },
                    render: function (e) {
                    ...
                    set: function (e, n, i) {
                        ...
                        if (i = r && t.isPlainObject(n) ? n : i || {}, e) {
                            r || (s[e] = n);
                            for (o in s) a = s[o], o in I.component.item && (void 0 === a && (a = null), I.component.set(o, a, i)), "select" != o && "clear" != o || T.val("clear" == o ? "" : I.get(o, C.format)).trigger("change");
                            I.render()
                        }
                    ...
                    on: function (e, n, i) {
                        ...
                        if (e) {
                            r || (s[e] = n);
                            for (o in s) a = s[o], i && (o = "_" + o), k.methods[o] = k.methods[o] || [], k.methods[o].push(a)
                        }
                        return I
                    },
                    off: function () {
                        var t, e, n = arguments;
                        for (t = 0, namesCount = n.length; t < namesCount; t += 1)(e = n[t]) in k.methods && delete k.methods[e];
                        return I
                    },
    ...
    function (t) {
        ...
        function n(t, e) {
            ...
            }(n.item.disable), n.set("min", e.min).set("max", e.max).set("now"), r ? n.set("select", r, {
                format: s,
                defaultValue: !0
        ...
        n.prototype.set = function (t, e, n) {
            ...
            var a, r = this;
            return n = void 0 === n ? t : n, n == -(1 / 0) || n == 1 / 0 ? a = n : e.isPlainObject(n) && i.isInteger(n.pick) ? n = n.obj : e.isArray(n) ? (n = new Date(n[0], n[1], n[2]), n = i.isDate(n) ? n : r.create().obj) : n = i.isInteger(n) || i.isDate(n) ? r.normalize(new Date(n), o) : r.now(t, n, o), {
            ...
            return i.isInteger(t) || (t = a(t)), i.isInteger(n) || (n = a(n)), i.isInteger(t) && e.isPlainObject(n) ? t = [n.year, n.month, n.date + t] : i.isInteger(n) && e.isPlainObject(t) && (n = [t.year, t.month, t.date + n]), {
                from: a(t),
                to: a(n)
            }
            ...
            var o, a, r, s, l = e.isArray(n),
                c = e.isPlainObject(n),
                u = this.item.view;
            if (l || c) {
                for (c ? (a = n.year, r = n.month, s = n.date) : (a = +n[0], r = +n[1], s = +n[2]), i && i.nav && u && u.month !== r && (a = u.year, r = u.month), o = new Date(a, r + (i && i.nav ? i.nav : 0), 1), a = o.getFullYear(), r = o.getMonth(); new Date(a, r, s).getMonth() !== r;) s -= 1;
                n = [a, r, s]
            }
            return n
            ...
            if ((!o || !o.nav && !o.defaultValue) && (!h && c.disabled(n) || h && c.disabled(n) && (m || a || r) || !h && (n.pick <= p.pick || n.pick >= f.pick)))
                for (h && !m && (!r && d > 0 || !a && d < 0) && (d *= -1); c.disabled(n) && (Math.abs(d) > 1 && (n.month < u.month || n.month > u.month) && (n = u, d = d > 0 ? 1 : -1), n.pick <= p.pick ? (s = !0, d = 1, n = c.create([p.year, p.month, p.date + (n.pick === p.pick ? 0 : -1)])) : n.pick >= f.pick && (l = !0, d = -1, n = c.create([f.year, f.month, f.date + (n.pick === f.pick ? 0 : 1)])), !s || !l);) n = c.create([n.year, n.month, n.date + d]);
            return n
            ...
            return "flip" == n ? o.flipEnable() : n === !1 ? (o.flipEnable(1), a = []) : n === !0 ? (o.flipEnable(-1), a = []) : n.map(function (t) {
            ...
            var o = this,
                a = o.item.disable,
                r = a.length;
            return "flip" == n ? o.flipEnable() : n === !0 ? (o.flipEnable(1), a = []) : n === !1 ? (o.flipEnable(-1), a = []) : n.map(function (t) {
                var n, s, l, c;
                for (l = 0; l < r; l += 1) {
            ...
            var e = this,
                ...
                p = function (t) {
                    return i.node("div", " ", n.klass["nav" + (t ? "Next" : "Prev")] + (t && l.year >= d.year && l.month >= d.month || !t && l.year <= u.year && l.month <= u.month ? " " + n.klass.navDisabled : ""), "data-nav=" + (t || -1) + " " + i.ariaAttr({
                        role: "button",
            ...
            return i.node("div", (n.selectYears ? m() + f() : f() + m()) + p() + p(1), n.klass.header) + i.node("table", h + i.node("tbody", i.group({
                min: 0,
                max: 5,
                i: 1,
                node: "tr",
                ...
                readonly: !0
            })) + i.node("div", i.node("button", n.today, n.klass.buttonToday, "type=button data-pick=" + a.pick + (t && !e.disabled(a) ? "" : " disabled") + " " + i.ariaAttr({
                controls: e.$node[0].id
    ...
    function () {
        ...
        function i(i, r) {
            ...
            var _, E, O, L, F = a('<div class="clockpicker-tick"></div>');
            if (r.twelvehour)
                for (_ = 1; _ < 13; _ += 1) E = F.clone(), O = _ / 6 * Math.PI, L = y, E.css("font-size", "140%"), E.css({
                    left: v + Math.sin(O) * L - x,
                    top: v - Math.cos(O) * L - x
                }), E.html(0 === _ ? "00" : _), g.append(E), E.on(h, l);
            else
                for (_ = 0; _ < 24; _ += 1) {
                    ...
                    L = R ? b : y, E.css({
                        left: v + Math.sin(O) * L - x,
                        top: v - Math.cos(O) * L - x
                    }), R && E.css("font-size", "120%"), E.html(0 === _ ? "00" : _), g.append(E), E.on(h, l)
                }
            for (_ = 0; _ < 60; _ += 5) E = F.clone(), O = _ / 30 * Math.PI, E.css({
                left: v + Math.sin(O) * y - x,
                top: v - Math.cos(O) * y - x
            }), E.css("font-size", "140%"), E.html(e(_)), S.append(E), E.on(h, l);
        ...
        i.DEFAULTS = {
            ...
            this.options.twelvehour && (n += this.amOrPm), this.input.prop("value", n), n !== t && (this.input.triggerHandler("change"), this.isInput || this.element.trigger("change")), this.options.autoclose && this.input.trigger("blur"),
    ...
    function (t, e) {
        ...
        return function (t, e, n, i) {
            var o = {
                ...
                detectFeatures: function () {
                    ...
                    for (var c, u, d = ["transform", "perspective", "animationName"], h = ["", "webkit", "Moz", "ms", "O"], p = 0; 4 > p; p++) {
                        n = h[p];
                        for (var f = 0; 3 > f; f++) c = d[f], u = n + (n ? c.charAt(0).toUpperCase() + c.slice(1) : c), !i[c] && u in e && (i[c] = u);
            ...
            o.extend(r, i);
            var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, C, S, T, M, I, A, P, D, _, E, O, L, F, R, W, V, z, N, H, B, Y, j, $, X, q, U, Q, Z, G, K, J, tt, et, nt, it, ot, at, rt, st, lt, ct = function () {
                return {
                    x: 0,
                    y: 0
                }
                ...
                Ot = function (t, e) {
                    if (!r.loop && e) {
                        var n = u + (gt.x * ft - t) / gt.x,
                            i = Math.round(t - fe.x);
                        (0 > n && i > 0 || n >= Qe() - 1 && 0 > i) && (t = fe.x + i * r.mainScrollEndFriction)
                    }
                    fe.x = t, Et(t, d)
                },
                Lt = function (t, e) {
                ...
                $t = function () {
                    ...
                    A = "left", o.addClass(t, "pswp--ie"), Et = function (t, e) {
                        e.left = t + "px"
                    }, _t = function (t) {
                ...
                ee = {
                    ...
                    init: function () {
                        if (!s && !l) {
                            var n;
                            a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), O = t.className, s = !0, W = o.detectFeatures(), _ = W.raf, E = W.caf, A = W.transform, F = W.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{
                                ...
                                wrap: 0,
                                index: -1
                            }], k[0].el.style.display = k[2].el.style.display = "none", $t(), m = {
                                resize: a.updateSize,
                                scroll: Ut,
                                keydown: Xt,
                                click: qt
                            ...
                            for (W.animationName && W.transform && !i || (r.showAnimationDuration = r.hideAnimationDuration = 0), n = 0; n < bt.length; n++) a["init" + bt[n]]();
                            if (e) {
                                (a.ui = new e(a, o)).init()
                            }
                            Mt("firstUpdate"), u = u || r.index || 0, (isNaN(u) || 0 > u || u >= Qe()) && (u = 0), a.currItem = Ue(u), (W.isOldIOSPhone || W.isOldAndroid) && (yt = !1), t.setAttribute("aria-hidden", "false"), r.modal && (yt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === R && (Mt("initialLayout"), R = L = o.getScrollY());
                            var c = "pswp--open ";
                            for (r.mainClass && (c += r.mainClass + " "), r.showHideOpacity && (c += "pswp--animate_opacity "), c += D ? "pswp--touch" : "pswp--notouch", c += W.animationName ? " pswp--css_animation" : "", c += W.svg ? " pswp--svg" : "", o.addClass(t, c), a.updateSize(), h = -1, vt = null, n = 0; 3 > n; n++) Et((n + h) * gt.x, k[n].el.style);
                    ...
                    goTo: function (t) {
                        t = Ct(t);
                        var e = t - u;
                        vt = e, u = t, a.currItem = Ue(u), ft -= e, Ot(gt.x * ft), Jt(), nt = !1, a.updateCurrItem()
                    },
                    next: function () {
                        a.goTo(u + 1)
                    },
                    ...
                    updateCurrZoomItem: function (t) {
                        ...
                        tt = a.currItem.bounds, v = g = a.currItem.initialZoomLevel, ht.x = tt.center.x, ht.y = tt.center.y, t && Mt("afterChange")
                    },
                    ...
                    updateCurrItem: function (t) {
                        if (0 !== vt) {
                            var e, n = Math.abs(vt);
                            if (!(t && 2 > n)) {
                                a.currItem = Ue(u), wt = !1, Mt("beforeChange", vt), n >= 3 && (h += vt + (vt > 0 ? -3 : 3), n = 3);
                                for (var i = 0; n > i; i++) vt > 0 ? (e = k.shift(), k[2] = e, h++ , Et((h + 2) * gt.x, e.el.style), a.setContent(e, u - n + i + 1 + 1)) : (e = k.pop(), k.unshift(e), h-- , Et(h * gt.x, e.el.style), a.setContent(e, u + n - i - 1 - 1));
                                if (et && 1 === Math.abs(vt)) {
                                    var o = Ue(C);
                    ...
                    updateSize: function (e) {
                        if (!yt && r.modal) {
                            var n = o.getScrollY();
                            if (R !== n && (t.style.top = n + "px", R = n), !e && xt.x === window.innerWidth && xt.y === window.innerHeight) return;
                        ...
                        if (pt.x = a.scrollWrap.clientWidth, pt.y = a.scrollWrap.clientHeight, Ut(), gt.x = pt.x + Math.round(pt.x * r.spacing), gt.y = pt.y, Ot(gt.x * ft), Mt("beforeResize"), void 0 !== h) {
                            for (var i, s, l, c = 0; 3 > c; c++) i = k[c], Et((c + h) * gt.x, i.el.style), l = u + c - 1, r.loop && Qe() > 2 && (l = Ct(l)), s = Ue(l), s && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(i, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === i.index && l >= 0 && a.setContent(i, l), s && s.container && (on(s, pt), ln(s), _t(s));
                            w = !1
                        }
                    ...
                    zoomTo: function (t, e, n, i, a) {
                        e && (v = g, me.x = Math.abs(e.x) - ht.x, me.y = Math.abs(e.y) - ht.y, Ft(dt, ht));
                        var r = Ht(t, !1),
                            s = {};
                ...
                Fe = function (t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!Y || "mousedown" !== t.type) {
                            ...
                            var n = Oe(t),
                                i = n.length;
                            Z = null, Jt(), j && 1 !== i || (j = ot = !0, o.bind(window, p, a), H = st = at = B = Q = q = $ = X = !1, it = null, Mt("firstTouchStart", n), Ft(dt, ht), ut.x = ut.y = 0, Ft(ae, n[0]), Ft(re, ae), le.x = gt.x * ft, ce = [{
                                x: ae.x,
                                y: ae.y
                            }], z = V = It(), Ht(g, !0), xe(), we()), !G && i > 1 && !nt && !Q && (v = g, X = !1, G = $ = !0, ut.y = ut.x = 0, Ft(dt, ht), Ft(ne, n[0]), Ft(ie, n[1]), Ie(ne, ie, ge), me.x = Math.abs(ge.x) - ht.x, me.y = Math.abs(ge.y) - ht.y, K = J = be(ne, ie))
                        }
                    }
                },
                Re = function (t) {
                ...
                We = function () {
                    if (Z) {
                        var t = Z.length;
                        if (0 !== t)
                            if (Ft(ne, Z[0]), oe.x = ne.x - ae.x, oe.y = ne.y - ae.y, G && t > 1) {
                                if (ae.x = ne.x, ae.y = ne.y, !oe.x && !oe.y && ve(Z[1], ie)) return;
                                ...
                                0 > i && (i = 0), K = e, Ie(ne, ie, he), ut.x += he.x - ge.x, ut.y += he.y - ge.y, Ft(ge, he), ht.x = Lt("x", n), ht.y = Lt("y", n), H = n > g, g = n, Dt()
                            } else {
                                if (!it) return;
                                if (ot && (ot = !1, Math.abs(oe.x) >= 10 && (oe.x -= Z[0].x - re.x), Math.abs(oe.y) >= 10 && (oe.y -= Z[0].y - re.y)), ae.x = ne.x, ae.y = ne.y, 0 === oe.x && 0 === oe.y) return;
                ...
                Ve = function (t) {
                    ...
                    1 === c && Ft(re, l[0]), 0 !== c || it || nt || (e || ("mouseup" === t.type ? e = {
                        x: t.pageX,
                        y: t.pageY,
                        type: "mouse"
                    ...
                    var u = -1;
                    if (0 === c && (j = !1, o.unbind(window, p, a), xe(), G ? u = 0 : -1 !== pe && (u = It() - pe)), pe = 1 === c ? It() : -1, s = -1 !== u && 150 > u ? "zoom" : "swipe", G && 2 > c && (G = !1, 1 === c && (s = "zoomPointerUp"), Mt("zoomGestureEnded")), Z = null, q || X || nt || B)
                ...
                He = function (t, e) {
                    ...
                    var c;
                    i && (u += i, 0 > u ? (u = r.loop ? Qe() - 1 : 0, c = !0) : u >= Qe() && (u = r.loop ? 0 : Qe() - 1, c = !0), (!c || r.loop) && (vt += i, ft -= i, n = !0));
                    var d, h = gt.x * ft,
                        p = Math.abs(h - fe.x);
                    return n || h > fe.x == e.lastFlickSpeed.x > 0 ? (d = Math.abs(e.lastFlickSpeed.x) > 0 ? p / Math.abs(e.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, de === u && (n = !1), nt = !0, Mt("mainScrollAnimStart"), te("mainScroll", fe.x, h, d, o.easing.cubic.out, Ot, function () {
            ...
            var je, $e, Xe, qe, Ue, Qe, Ze, Ge = function (e, n, i, s) {
                ...
                on = function (t, e, n) {
                    if (t.src && !t.loadError) {
                        ...
                        if (i && (t.vGap || (t.vGap = {
                            top: 0,
                            bottom: 0
                        }), Mt("parseVerticalMargin", t)), Ke.x = e.x, Ke.y = e.y - t.vGap.top - t.vGap.bottom, i) {
                            var o = Ke.x / t.w,
                                a = Ke.y / t.h;
                            t.fitRatio = a > o ? o : a;
                            var s = r.scaleMode;
                ...
                cn = function () {
                    if (Je.length) {
                        for (var t, e = 0; e < Je.length; e++) t = Je[e], t.holder.index === t.index && an(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
                        Je = []
                    }
                };
            kt("Controller", {
                publicMethods: {
                    lazyLoadItem: function (t) {
                        t = Ct(t);
                        var e = Ue(t);
                        e && (!e.loaded && !e.loading || w) && (Mt("gettingData", t, e), e.src && rn(e))
                    },
                    initController: function () {
                        o.extend(r, tn, !0), a.items = $e = n, Ue = a.getItemAt, Qe = r.getNumItemsFn, Ze = r.loop, Qe() < 3 && (r.loop = !1), Tt("beforeChange", function (t) {
                            var e, n = r.preload,
                                ...
                                s = Math.min(n[1], Qe());
                            for (e = 1;
                                (i ? s : o) >= e; e++) a.lazyLoadItem(u + e);
                            for (e = 1;
                                (i ? o : s) >= e; e++) a.lazyLoadItem(u - e)
                        }), Tt("initialLayout", function () {
                            a.currItem.initialLayout = r.getThumbBoundsFn && r.getThumbBoundsFn(u)
                        }), Tt("mainScrollAnimComplete", cn), Tt("initialZoomInEnd", cn), Tt("destroy", function () {
                            for (var t, e = 0; e < $e.length; e++) t = $e[e], t.container && (t.container = null), t.placeholder && (t.placeholder = null), t.img && (t.img = null), t.preloader && (t.preloader = null), t.loadError && (t.loaded = t.loadError = !1);
                            Je = null
                        })
                    },
                    ...
                    setContent: function (t, e) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), sn(l), on(l, pt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && (i = o.createEl("pswp__img", "img"), i.style.opacity = 1, i.src = l.src, ln(l, i), an(0, l, c, i));
                        else {
                            if (l.loadComplete = function (n) {
                                if (s) {
                                    if (t && t.index === e) {
                                        if (sn(n, !0)) return n.loadComplete = n.img = null, on(n, pt), _t(n), void (t.index === u && a.updateCurrZoomItem());
                                        n.imageAppended ? !qe && n.placeholder && (n.placeholder.style.display = "none", n.placeholder = null) : W.transform && (nt || qe) ? Je.push({
                                            item: n,
                                            baseDiv: c,
                                            img: n.img,
                                            index: e,
                                ...
                                l.msrc && (h.src = l.msrc), ln(l, h), c.appendChild(h), l.placeholder = h
                            }
                            l.loading || rn(l), a.allowProgressiveImg() && (!Xe && W.transform ? Je.push({
                                item: l,
                                baseDiv: c,
                                img: l.img,
                                index: e,
            ...
            kt("Tap", {
                publicMethods: {
                    ...
                    onTapRelease: function (t, e) {
                        if (e && !q && !$ && !Zt) {
                            var n = e;
                            if (un && (clearTimeout(un), un = null, ye(n, dn))) return void Mt("doubleTap", n);
                            if ("mouse" === e.type) return void hn(t, e, "mouse");
                            if ("BUTTON" === t.target.tagName.toUpperCase() || o.hasClass(t.target, "pswp__single-tap")) return void hn(t, e);
                            Ft(dn, n), un = setTimeout(function () {
                                hn(t, e), un = null
                            }, 300)
                        }
                    }
            ...
            kt("DesktopZoom", {
                publicMethods: {
                    ...
                    handleMouseWheel: function (t) {
                        if (g <= a.currItem.fitRatio) return r.modal && (!r.closeOnScroll || Zt || j ? t.preventDefault() : A && Math.abs(t.deltaY) > 2 && (c = !0, a.close())), !0;
            ...
            var fn, mn, gn, vn, yn, bn, xn, wn, kn, Cn, Sn, Tn, Mn = {
                history: !0,
                galleryUID: 1
            },
                In = function () {
                ...
                Dn = function () {
                    if (gn && clearTimeout(gn), Zt || j) return void (gn = setTimeout(Dn, 500));
                    ...
                    Tn ? "#" + n !== window.location.hash && history[wn ? "replaceState" : "pushState"]("", document.title, i) : wn ? Sn.replace(i) : Sn.hash = n, wn = !0, mn = setTimeout(function () {
                        vn = !1
                    }, 60)
                };
            kt("History", {
    ...
    function (t, e) {
        ...
        "use strict";
        return function (t, e) {
            var n, i, o, a, r, s, l, c, u, d, h, p, f, m, g, v, y, b, x, w = this,
                k = !1,
                C = !0,
                S = !0,
                T = {
                ...
                M = function (t) {
                    ...
                    for (var n, i, o = t.target || t.srcElement, a = o.getAttribute("class") || "", r = 0; r < j.length; r++) n = j[r], n.onTap && a.indexOf("pswp__" + n.name) > -1 && (n.onTap(), i = !0);
                    if (i) {
                ...
                E = function (e) {
                    ...
                    return t.shout("shareLinkClick", e, n), !!n.href && (!!n.hasAttribute("download") || (window.open(n.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), S || _(), !1))
                },
                O = function () {
                    for (var t, e, n, i, o, a = "", r = 0; r < g.shareButtons.length; r++) t = g.shareButtons[r], n = g.getImageURLForShare(t), i = g.getPageURLForShare(t), o = g.getTextForShare(t), e = t.url.replace("{{url}}", encodeURIComponent(i)).replace("{{image_url}}", encodeURIComponent(n)).replace("{{raw_image_url}}", n).replace("{{text}}", encodeURIComponent(o)), a += '<a href="' + e + '" target="_blank" class="pswp__share--' + t.id + '"' + (t.download ? "download" : "") + ">" + t.label + "</a>", g.parseShareButtonOut && (a = g.parseShareButtonOut(t, a));
                    ...
                    var t, n, o, a = function (i) {
                        if (i)
                            for (var a = i.length, r = 0; a > r; r++) {
                                t = i[r], n = t.className;
                                for (var s = 0; s < j.length; s++) o = j[s], n.indexOf("pswp__" + o.name) > -1 && (g[o.option] ? (e.removeClass(t, "pswp__element--disabled"), o.onInit && o.onInit(t)) : e.addClass(t, "pswp__element--disabled"))
                            }
                    };
                    a(i.children);
...
var initPhotoSwipeFromDOM = function (t) {
    for (var e = function (t) {
        for (var e, n, i, o, a = t.childNodes, r = a.length, s = [], l = 0; l < r; l++) e = a[l], 1 === e.nodeType && (n = e.children[0], i = n.getAttribute("data-size").split("x"), o = {
        ...
        var a, r, s, l = document.querySelectorAll(".pswp")[0];
        if (s = e(n), r = {
        ...
        isNaN(r.index) || (i && (r.showAnimationDuration = 0), a = new PhotoSwipe(l, PhotoSwipeUI_Default, s, r), a.init())
    }, a = document.querySelectorAll(t), r = 0, s = a.length; r < s; r++) a[r].setAttribute("data-pswp-uid", r + 1), a[r].onclick = i;
    var l = function () {
        ...
        10: [function (t, e, n) {
            ...
            function i(t, e) {
                ...
                e.event.bind(e.scrollbarY, "click", i), e.event.bind(e.scrollbarYRail, "click", function (i) {
                    ...
                    r(t, "top", t.scrollTop + s * e.containerHeight), a(t), i.stopPropagation()
                    ...
                    r(t, "left", t.scrollLeft + s * e.containerWidth), a(t), i.stopPropagation()
                })
            }
            var o = t("../instances"),
                a = t("../update-geometry"),
        ...
        11: [function (t, e, n) {
            ...
            function i(t, e) {
                function n(n) {
                    ...
                    e.scrollbarXLeft = o < 0 ? 0 : o > r ? r : o, c(t, "left", a.toInt(e.scrollbarXLeft * (e.contentWidth - e.containerWidth) / (e.containerWidth - e.railXRatio * e.scrollbarXWidth)) - e.negativeScrollAdjustment)
                }
                var i = null,
                    o = null,
                    s = function (e) {
            ...
            function o(t, e) {
                function n(n) {
                    ...
                    e.scrollbarYTop = o < 0 ? 0 : o > r ? r : o, c(t, "top", a.toInt(e.scrollbarYTop * (e.contentHeight - e.containerHeight) / (e.containerHeight - e.railYRatio * e.scrollbarYHeight)))
                }
                var i = null,
                    o = null,
                    s = function (e) {
            ...
            function i(t, e) {
                ...
                e.event.bind(e.ownerDocument, "selectionchange", function () {
                    ...
                    if (d) {
                        ...
                        n.x < a.left + 3 ? (u.left = -5, o.startScrolling(t, "x")) : n.x > a.right - 3 ? (u.left = 5, o.startScrolling(t, "x")) : u.left = 0, n.y < a.top + 3 ? (a.top + 3 - n.y < 5 ? u.top = -5 : u.top = -20, o.startScrolling(t, "y")) : n.y > a.bottom - 3 ? (n.y - a.bottom + 3 < 5 ? u.top = 5 : u.top = 20, o.startScrolling(t, "y")) : u.top = 0, 0 === u.top && 0 === u.left ? l() : i()
                    }
                })
            }
            var o = t("../../lib/helper"),
        ...
        16: [function (t, e, n) {
            ...
            function i(t, e, n, i) {
                function o(n, i) {
                    ...
                    } else if (r > s && (n < 0 && a === e.contentWidth - e.containerWidth || n > 0 && 0 === a)) return !e.settings.swipePropagation;
                    return !0
                }
                function l(e, n) {
            ...
            return this.$el = t(this), this.$document = t(document), this.SELS = {
                ...
                o.$document.on("click", e.CHIPS, function (n) {
                    ...
                    if (!t(n.target).is("input, textarea")) {
                        var i, a = o.$document.find(e.CHIP + e.SELECTED_CHIP),
                            r = a.closest(e.CHIPS),
                        ...
                        if (a.length) {
                            ...
                            if (l) {
                                ...
                                if (i = a.index() + 1, t(e.CHIP).removeClass("selected"), i > s) return void r.find("input").focus();
                    ...
                    if (13 === n.which) return n.preventDefault(), o.addChip(r, {
                        tag: i.val()
                    }, a), void i.val("");
    ...
    function (t) {
        ...
        function o(e) {
            t.requestAnimationFrame(function () {
                "scroll" !== e.type && n();
                for (var t = 0, i = g.length; t < i; t++) "scroll" !== e.type && (g[t].coverImage(), g[t].clipContainer()), g[t].onScroll()
            })
        }
        ...
        var a, r, s = document.createElement("div"),
            l = e("transform"),
            c = e("perspective"),
            ...
            v = function () {
                function t(t, n) {
                    ...
                    if (o.$item = t, o.defaults = {
                        ...
                        a && "object" == typeof a && void 0 !== a.length && (a = a[0]), !a instanceof Element && (a = null), o.options.elementInViewport = a, o.instanceID = e++ , o.image = {
        ...
        v.prototype.css = function (e, n) {
            ...
            for (var o = 0, a = e.$item; null !== a && a !== document && 0 === o;) {
                ...
                r && "none" !== r && (o = 1, e.css(e.image.$container, {
            ...
            if (t.image.width && t.image.height) {
                var e = t.image.$container.getBoundingClientRect(),
                    ...
                    p = 0,
                    f = 0;
                c && (u = l < 0 ? l * Math.max(i, r) : l * (i + r), l > 1 ? h = Math.abs(u - r) : l < 0 ? h = u / l + Math.abs(u) : h += Math.abs(r - i) * (1 - l), u /= 2), d = h * a / s, d < n && (d = n, h = d * s / a), c ? (p = o + (n - d) / 2, f = (r - h) / 2) : (p = (n - d) / 2, f = (i - h) / 2), "absolute" === t.image.position && (p -= o), t.parallaxScrollDistance = u, t.css(t.image.$item, {
                    width: d + "px",
                    height: h + "px",
                    marginLeft: p + "px",
                    marginTop: f + "px"
        ...
        var y = function (t) {
            ...
            var e, n = arguments[1],
                ...
                a = 0;
            for (a; a < o; a++)
                if ("object" == typeof n || void 0 === n ? t[a].jarallax || (t[a].jarallax = new v(t[a], n)) : t[a].jarallax && (e = t[a].jarallax[n].apply(t[a].jarallax, i)), void 0 !== e) return e;
            return t
        };
        y.constructor = v;
        var b = t.jarallax;
            ...
            n.onAPIready(function () {
                ...
                if ("local" === n.type) {
                    if (!n.$iframe) {
                        ...
                        for (var u in n.videoID) ! function (t, e, n) {
            ...
            t.prototype.init = function () {
                ...
                e.apply(t), t.video && t.video.getIframe(function (e) {
                    ...
                    t.css(e, {
                        ...
                        margin: 0,
                        zIndex: -1
                    }), t.$video = e, t.image.$container.appendChild(e), n.parentNode.removeChild(n)
                })
            };
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (function (e) {
    ...
    $(".navbar").offset() && ($(".navbar").offset().top > OFFSET_TOP ? $(".scrolling-navbar").addClass("top-nav-collapse") : $(".scrolling-navbar").removeClass("top-nav-collapse"))
    }), $(function () {
