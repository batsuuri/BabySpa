...
namespace BabySpa.Core
{
    public class Main
    {
        ...
        public static Result DataSetExecute(string sql)
        {
            ...
            {
                Data = CDataCon.ExecuteDataset(GetConStr(), System.Data.CommandType.Text, sql)
            };
        ...
        public static Result DataSPExecute(string spname, SqlParameter[] obj)
        {
            Result res = new Result(true);

            res.Data = CDataCon.ExecuteDataset(GetConStr(), System.Data.CommandType.StoredProcedure, spname, obj);
        ...
        public static Result ExecuteNonQuery(string sql, SqlParameter[] obj)
        {
            ...
            res.Data = CDataCon.ExecuteNonQuery(GetConStr(), System.Data.CommandType.Text, sql, obj);
        ...
        public static Result ExecuteNonQuery(string sql)
        {
            ...
            res.Data = CDataCon.ExecuteNonQuery(GetConStr(), System.Data.CommandType.Text, sql);
        ...
        public static async Task SendMail(string[] to, string body, string subject, string[] cc = null)
        {

            MailMessage mail = new MailMessage();

            //Setting From , To and CC
            mail.From = new MailAddress(App.getWebConfigValue("SmtpUsername"), App.getWebConfigValue("SmtpEMailFrom"));
            ...
            client.Credentials = new System.Net.NetworkCredential(App.getWebConfigValue("SmtpUsername"), App.getWebConfigValue("SmtpPassword"));
            //client.UseDefaultCredentials = false;
            client.DeliveryMethod = SmtpDeliveryMethod.Network;
            client.Port = Func.ToInt(App.getWebConfigValue("SmtpPort"));
            client.Host = App.getWebConfigValue("SmtpServer");
            ...
            catch (Exception ex)
            {
                ...
                Main.LogWrite(Main.apppath + "\\Log\\Error_Email_" + DateTime.Now.ToString("yyyyMMdd") + ".log", errorMessage);
            }
        }
        ...
        public static void LogWrite(string filename, String pText)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append(pText);
            LogWrite(filename, sb);
        }
