...
namespace BabySpa
{
    public static class CultureHelper
    {
        ...
        "jp", // Japan NEUTRAL culture
        "ko", // Korea NEUTRAL culture
        ...
        public static string GetRes(string tablename, string columnname, string keyfield, string culture,string defaultvalue) {
            ...
            try
            {
                string key = Func.ToStr(tablename + "_" + columnname + "_" + keyfield + "_" + culture).ToLower();
                if (App.globTextsHT.ContainsKey(key))
                {
                    ret = Func.ToStr(App.globTextsHT[key]);
                }
            }
            catch (Exception ex)
            {
        ...
        {
         return GetRes(tablename,columnname,keyfield,GetCurrentCulture(), defaultvalue);
        }
